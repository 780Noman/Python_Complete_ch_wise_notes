...
#With block in file.
#in which block file are automatically close.

with open("Nomi11.txt") as fptr:
    print(fptr.readlines());
    print(fptr.readline());#It not working ..

#Yes,it work because with block close file automatic.
f=open("Nomi11.txt");
print(f.read());
f.close();